...
<div class="email-wrap">
  <div class="top-part-wrap">
    <div class="header-title">
      <h1>Hi, {{ $smtp_username }}</h1>
    </div>
  </div>

  <div class="content-wrap">
    <div class="content-text">
      <p>This is a test email which ensures that your SMTP connection for VoxMind is working.</p>
    </div>
  </div>

  <div class="footer-wrap">
    <div class="copyright-wrap">&copy; <a href="mailto:info@voxmind.com">info@voxmind.com</a></div>
  </div>
</div>
